...
class Kohut_SNMP_Printer extends Kohut_SNMP_Abstract
{
    ...
    public function getFactoryId(){
        return substr($this->getSNMPString(self::SNMP_PRINTER_FACTORY_ID),8);
    }
    /**
    ...
    public function getVendorName(){
        return substr($this->getSNMPString(self::SNMP_PRINTER_VENDOR_NAME),8);
    }
	/**************************************************************************************************/
	/*	TEST IF Vendor Name is OKI....																  */
	/**************************************************************************************************/
	public function testVendorNameOki() {	
		return substr_compare(strtolower($this->getFactoryId()),"oki",0,4);
	}
	/*************************************************************************************************
    ...
    {
        return substr($this->getSNMPString(self::SNMP_PRINTER_SERIAL_NUMBER),8);
    }
    ...
    public function getBlackCatridgeType(){
        if ($this->isColorPrinter()) {
			if ($this->testVendorNameOki() == 1) {
				return substr($this->getSNMPString(self::SNMP_SUB_UNIT_TYPE_SLOT_1),8);
			}else{
				return substr($this->getSNMPString(self::SNMP_SUB_UNIT_TYPE_SLOT_4),8);
			}	
    ...
    public function getCyanCatridgeType(){
        if ($this->isColorPrinter()) {
			if ($this->testVendorNameOki() == 1) {
				return substr($this->getSNMPString(self::SNMP_SUB_UNIT_TYPE_SLOT_2),8);
			}else{
				return substr($this->getSNMPString(self::SNMP_SUB_UNIT_TYPE_SLOT_1),8);
			}	
        } else {
    ...
    public function getMagentaCatridgeType(){
        if ($this->isColorPrinter()) {
            if ($this->testVendorNameOki() == 1) {
				return substr($this->getSNMPString(self::SNMP_SUB_UNIT_TYPE_SLOT_3),8);
			}else{
				return substr($this->getSNMPString(self::SNMP_SUB_UNIT_TYPE_SLOT_2),8);
			}
        } else {
    ...
    protected function getSubUnitPercentageLevel($maxValueSNMPSlot, $actualValueSNMPSlot){
        $max = substr($this->get($maxValueSNMPSlot),8);
        $actual = substr($this->get($actualValueSNMPSlot),8);
